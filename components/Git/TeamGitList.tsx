...
export type TeamGitListLayoutProps = Pick<ScrollListProps<GitTemplate>, 'defaultData'> &
  ...
  <Row as="ul" className="list-unstyled g-4" xs={1} sm={2}>
    {defaultData?.map(item => (
      <Col key={item.id} as="li">
        <GitTeamCard className="h-100 shadow-sm" {...item} renderController={renderController} />
      </Col>
    ))}
  </Row>
);
