...
export default {
  ...
  hero_subtitle:
    'Open Hackathon Platform unites organizers, mentors, sponsors, and teams so every event feels thoughtful, accessible, and fast.',
  hero_stat_events: 'Hackathons shipped',
  hero_stat_builders: 'Active builders',
  hero_stat_cities: 'Cities represented',
  ...
  features_section_title: 'Capabilities',
  features_section_subtitle: 'Everything you need to run memorable hackathons',
  feature_speed_title: 'Launch faster',
  feature_speed_desc:
    'Use ready-made templates, enrollment flows, and judging stages tuned for hybrid events.',
  feature_tooling_title: 'Built-in tooling',
  feature_tooling_desc: 'Coordinate teams, partners, and submissions with intuitive dashboards.',
  feature_support_title: 'Community support',
  feature_support_desc: 'Bring mentors, sponsors, and hackers together with transparent updates.',
  featured_section_title: 'Trending hackathons',
  featured_section_subtitle: 'Fresh community events curated for you',
  ranking_section_title: 'Community talent spotlight',
  ranking_section_subtitle: 'Weekly leaderboards from our builder community',
  cta_section_title: 'Ready to launch your next sprint?',
  cta_section_desc:
    'Host a hackathon with opinionated workflows, reliable infrastructure, and beautiful defaults.',
  footer_links_resources: 'Resources',
  footer_links_actions: 'Take action',
  footer_links_connect: 'Connect',
