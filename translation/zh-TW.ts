...
export default {
  ...
  hero_subtitle:
    '開放黑客松平台把主辦方、導師、贊助商與參賽團隊聚在同一空間，讓每場活動都更易用、更開放。',
  hero_stat_events: '已上線黑客松',
  hero_stat_builders: '活躍創客',
  hero_stat_cities: '覆蓋城市',
  ...
  features_section_title: '能力矩陣',
  features_section_subtitle: '幫你運營難忘的黑客松',
  feature_speed_title: '極速發布',
  feature_speed_desc: '模板化的報名、評審與線上線下混合流程，幾分鐘即可上線。',
  feature_tooling_title: '內建協作',
  feature_tooling_desc: '用直覺的控制台協同團隊、合作夥伴以及作品提交通道。',
  feature_support_title: '社群支持',
  feature_support_desc: '透明溝通機制讓導師、贊助商與創客保持同頻。',
  featured_section_title: '精選活動',
  featured_section_subtitle: '即時推薦的社群黑客松',
  ranking_section_title: '社群創客榜',
  ranking_section_subtitle: '每週更新的貢獻者榜單',
  cta_section_title: '準備好下一場衝刺了嗎？',
  cta_section_desc: '用可靠的基礎設施與優雅預設，快速啟動一場黑客松。',
  footer_links_resources: '資源',
  footer_links_actions: '立即行動',
  footer_links_connect: '保持聯絡',
