...
export default {
  ...
  select: '选择',
  open_hackathon_platform: '黑客松开放平台',
  ...
  features_section_title: '能力矩阵',
  features_section_subtitle: '助你运营难忘的黑客松',
  feature_speed_title: '极速发布',
  feature_speed_desc: '模板化的报名、评审与线上线下混合流程，几分钟即可上线。',
  feature_tooling_title: '内置协作',
  feature_tooling_desc: '用直观的控制台协同团队、合作伙伴以及项目提交通道。',
  feature_support_title: '社区支持',
  feature_support_desc: '透明沟通机制让导师、赞助商与创客保持同频。',
  featured_section_title: '精选活动',
  featured_section_subtitle: '实时推荐的社区黑客松',
  ranking_section_title: '社区创客榜',
  ranking_section_subtitle: '每周更新的贡献者榜单',
  cta_section_title: '准备好下一场冲刺了吗？',
  cta_section_desc: '用可靠的基础设施和优雅默认形态，快速启动一场黑客松。',
  resources: '资源',
  action_now: '立即行动',
  keep_connection: '保持联络',
  feishu_wiki: '飞书 Wiki',
  status_page: '服务状态',
