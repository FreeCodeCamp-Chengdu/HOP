        ...
        <Row className="g-4">
          <Col xs={12} lg={3}>
            <Card border="secondery" className="border">
              ...
              <Card.Img className="mx-3 mb-3" style={{ width: '6.5rem' }} src={avatar} alt="" />
              <Card.Body className="text-start border-top p-3">
                <a target="_blank" href={`https://github.com/${name}`} rel="noreferrer">
                  <FontAwesomeIcon className="fa-stack text-success" icon={faGithub} />
                </a>
                <FontAwesomeIcon className="text-secondary fa-stack" icon={faQq} />
                <FontAwesomeIcon className="text-secondary fa-stack" icon={faWeixin} />
